...
/**
  ...
  Esta estructura contiene toda la información necesaria para hablar con un gnuplot
  sesión. Se construye y devuelve por gnuplot_init() y posteriormente se utiliza
  por todas las funciones de este módulo para comunicarse con la sesión, entonces
  destinado a ser cerrado por gnuplot_close().

  Esta estructura está pensada para permanecer opaca, normalmente no se necesita
  para saber lo que está contenido allí
...
/**
  ...
  Esto abre una nueva sesión de gnuplot, lista para ser introducida. La estructura
